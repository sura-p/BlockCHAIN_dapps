...
//after making part ,part receipt
        function partrecepit(bytes32 orderhash)public returns(bytes32){
            part_recepit memory recepit = part_recepit(orderhash,part[orderhash].price);
